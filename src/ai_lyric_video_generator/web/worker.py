...
from ai_lyric_video_generator.config import Config # Import Config for type hinting
...
from ai_lyric_video_generator.utils.song_utils import search_song # Import search_song directly
...
def reload_pending_tasks(config):
    ...
    from ai_lyric_video_generator.web import create_app
    from ai_lyric_video_generator.web.models import Task, TaskStatus
